...
$(document).on('click', '.restore_book', function() {
	if(!confirm("Are you sure to restore this book?")) {
		event.preventDefault();
		return;
	}
});
